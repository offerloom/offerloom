...
type Product = { id:string|number; icon:string; name:string; category:string; summary:string; specs:string[]; listings:Listing[] };
type ManagedProduct = { id:string; name:string; category:string; summary:string; specs:string[]; outboundPath:string };
